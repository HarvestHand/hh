                                   ...
                                   $renderParentClass)
    {
        ...
        foreach ($iterator as $page) {
            ...
            if ($depth > $prevDepth) {
                ...
                $attribs = empty($attribs)?['class' =>'dropdown-menu']:$attribs;
            ...
            if($page->hasChildren() && $maxDepth != 0){
                $page->setCustomHtmlAttrib('href',"#");
                $page->setCustomHtmlAttrib('data-toggle',"dropdown");
                $page->setCustomHtmlAttrib('role',"button");
                $page->setCustomHtmlAttrib('aria-haspopup',"true");
                $page->setCustomHtmlAttrib('aria-expanded',"false");
            }
