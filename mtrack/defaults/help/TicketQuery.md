...
To configure and execute a custom query, switch to the ''Reports'' module from the navigation bar, and select the ''Custom Query'' link.
...
{{{
[[TicketQuery(max=3,status=open,order=tid,desc=1,format=table,col=resolution|summary|owner)]]
}}}
